class mx.controls.Button extends mx.controls.SimpleButton
{
   ...
   function viewSkin(varName)
   {
      ...
      _loc3_ = _loc3_ + (!this.enabled?"disabled":this.phase);
   ...
   function setView(offset)
   {
      ...
      if(_loc12_ == "left" || _loc12_ == "right")
      {
         ...
         if(_loc12_ == "right")
         {
            ...
            {
               _loc5_ = _loc5_ + (_loc9_ - _loc11_ - _loc7_) / 2;
            }
         ...
         if(!this.centerContent)
         {
            _loc2_._y = _loc2_._y + Math.max(0,(_loc8_ - _loc6_) / 2);
         }
      }
      else
      {
         ...
         else
         {
            ...
            if(this.centerContent)
            {
               _loc4_ = _loc4_ + (_loc10_ - _loc8_ - _loc6_) / 2;
            }
      ...
      _loc2_._x = _loc2_._x + _loc13_;
      _loc2_._y = _loc2_._y + _loc13_;
   }
