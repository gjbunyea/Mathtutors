class mx.core.ScrollView extends mx.core.View
{
   ...
   function setScrollProperties(colCount, colWidth, rwCount, rwHeight, hPadding, wPadding)
   {
      ...
      var _loc4_ = Math.ceil((this.__width - _loc3_.left - _loc3_.right - this.widthPadding) / colWidth);
      if(this.__hScrollPolicy == "on" || _loc4_ < colCount && this.__hScrollPolicy == "auto")
      {
         ...
         if(this.numberOfCols != colCount || this.columnWidth != colWidth || this.viewableColumns != _loc4_ || this.scrollAreaChanged)
         {
            this.hScroller.setScrollProperties(_loc4_,0,colCount - _loc4_);
            this.viewableColumns = _loc4_;
      ...
      var _loc5_ = Math.ceil((this.__height - _loc3_.top - _loc3_.bottom - this.heightPadding) / rwHeight);
      var _loc8_ = (this.__height - _loc3_.top - _loc3_.bottom) % rwHeight != 0;
      if(this.__vScrollPolicy == "on" || _loc5_ < rwCount + _loc8_ && this.__vScrollPolicy == "auto")
      {
         ...
         if(this.rowC != rwCount || this.rowH != rwHeight || this.viewableRows + _loc8_ != _loc5_ + this.oldRndUp || this.scrollAreaChanged)
         {
            this.vScroller.setScrollProperties(_loc5_,0,rwCount - _loc5_ + _loc8_);
            this.viewableRows = _loc5_;
            this.rowC = rwCount;
            this.rowH = rwHeight;
