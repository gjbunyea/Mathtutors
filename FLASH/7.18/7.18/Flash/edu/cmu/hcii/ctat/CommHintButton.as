class edu.cmu.hcii.ctat.CommHintButton extends edu.cmu.hcii.ctat.CTATImageBasedButton
{
   static var symbolName = "CommHintButton";
   static var symbolOwner = edu.cmu.hcii.ctat.CommHintButton;
   var className = "CommHintButton";
   var ParentClassName = "CTATImageBasedButton";
   static var version = "2.10.1";
   var publicVersion = "2.10.1";
   function CommHintButton()
   {
      super();
   }
   function init()
   {
      ...
      _global.hintButton = this;
      this.setOverrideInstance("hint");
   ...
   function createChildren()
   {
      ...
      _global.theShell.setAlternativeHintButton(this);
   }
   function draw()
   {
      this.debug("draw ()");
